...
namespace MVCUniversity.Migrations
{
    ...
    [Migration("20210525150158_morepictures")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCUniversity.Areas.Identity.Data.MVCUniversityUSER", b =>
                {
            ...
            modelBuilder.Entity("MVCUniversity.Models.Course", b =>
                {
                    b.HasOne("MVCUniversity.Models.Teacher", "FirstTeacher")
                        .WithMany("CoursesFirst")
                        .HasForeignKey("FirstTeacherId");

                    b.HasOne("MVCUniversity.Models.Teacher", "SecondTeacher")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MVCUniversity.Areas.Identity.Data.MVCUniversityUSER", null)
                        .WithMany()
